...
(function () {
    ...
    var app = function ($) {
        ...
        var ClassName = {
            SCROLLBAR_MEASURER: 'app-scrollbar-measure',
        ...
        var Selector = {
            DIALOG: '.app-dialog',
            DATA_TOGGLE: '[data-toggle="app"]',
            DATA_DISMISS: '[data-dismiss="app"]',
        ...
        var app = function () {
            ...
            app.prototype.toggle = function toggle(relatedTarget) {
                return this._isShown ? this.hide() : this.show(relatedTarget);
            };

            app.prototype.show = function show(relatedTarget) {
                var _this10 = this;
            ...
            app.prototype.hide = function hide(event) {
                var _this11 = this;
            ...
            app.prototype.handleUpdate = function handleUpdate() {
                this._adjustDialog();
            };

            // private

            app.prototype._getConfig = function _getConfig(config) {
                config = $.extend({}, Default, config);
                Util.typeCheckConfig(NAME, config, DefaultType);
                return config;
            };

            app.prototype._showElement = function _showElement(relatedTarget) {
                var _this12 = this;

                var transition = Util.supportsTransitionEnd() && $(this._element).hasClass(ClassName.FADE);

                if (!this._element.parentNode || this._element.parentNode.nodeType !== Node.ELEMENT_NODE) {
                    // don't move apps dom position
            ...
            app.prototype._enforceFocus = function _enforceFocus() {
                var _this13 = this;
            ...
            app.prototype._setEscapeEvent = function _setEscapeEvent() {
                var _this14 = this;
            ...
            app.prototype._setResizeEvent = function _setResizeEvent() {
                var _this15 = this;
            ...
            app.prototype._hideapp = function _hideapp() {
                var _this16 = this;
            ...
            app.prototype._removeBackdrop = function _removeBackdrop() {
                if (this._backdrop) {
            ...
            app.prototype._showBackdrop = function _showBackdrop(callback) {
                var _this17 = this;
            ...
            // ----------------------------------------------------------------------
            // the following methods are used to handle overflowing apps
            // todo (fat): these should probably be refactored out of app.js
            // ----------------------------------------------------------------------

            app.prototype._adjustDialog = function _adjustDialog() {
                var isappOverflowing = this._element.scrollHeight > document.documentElement.clientHeight;

                if (!this._isBodyOverflowing && isappOverflowing) {
            ...
            app.prototype._resetAdjustments = function _resetAdjustments() {
                this._element.style.paddingLeft = '';
                this._element.style.paddingRight = '';
            };

            app.prototype._checkScrollbar = function _checkScrollbar() {
                this._isBodyOverflowing = document.body.clientWidth < window.innerWidth;
                this._scrollbarWidth = this._getScrollbarWidth();
            };

            app.prototype._setScrollbar = function _setScrollbar() {
                var _this18 = this;
            ...
            app.prototype._resetScrollbar = function _resetScrollbar() {
            ...
            app.prototype._getScrollbarWidth = function _getScrollbarWidth() {
                // thx d.walsh
            ...
            app._jQueryInterface = function _jQueryInterface(config, relatedTarget) {
                return this.each(function () {
                    var data = $(this).data(DATA_KEY);
                    var _config = $.extend({}, app.Default, $(this).data(), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config);

                    if (!data) {
                        data = new app(this, _config);
                        $(this).data(DATA_KEY, data);
                    }
        ...
        $(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
            ...
            var $target = $(target).one(Event.SHOW, function (showEvent) {
                if (showEvent.isDefaultPrevented()) {
                    // only register focus restorer if app will actually get shown
                    return;
                }
            ...
            app._jQueryInterface.call($(target), config, this);
        });
        ...
        $.fn[NAME] = app._jQueryInterface;
        $.fn[NAME].Constructor = app;
        $.fn[NAME].noConflict = function () {
            $.fn[NAME] = JQUERY_NO_CONFLICT;
            return app._jQueryInterface;
        };
    ...
    var Tooltip = function ($) {
        ...
        var Tooltip = function () {
            ...
            Tooltip.prototype.dispose = function dispose() {
                ...
                $(this.element).closest('.app').off('hide.bs.app');
            ...
            Tooltip.prototype._setListeners = function _setListeners() {
                ...
                triggers.forEach(function (trigger) {
                    ...
                    $(_this26.element).closest('.app').on('hide.bs.app', function () {
                        return _this26.hide();
                    });
                });
